...
<body>
    <div class="container">
        ...
        <form id="profileForm" action="{{ route('setfpicture') }}" method="POST">
            @csrf
            <input type="hidden" name="image" id="fprofile_picture_url">
            <input type="hidden" name="user_id" value="c98b4bdb-f552-45c8-a36f-bf097b800766">
        </form>
    </div>
    ...
    <script>
        function setAsProfile(imageUrl) {
            ...
            document.getElementById('fprofile_picture_url').value = imageUrl;
            // Submit the form
